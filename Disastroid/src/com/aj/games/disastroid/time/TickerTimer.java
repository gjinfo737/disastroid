...
public class TickerTimer {
	...
	public interface ITickerTimerListener {
		public void onTimerTick(List<TickInterval> intervals, int tick,
				long period);
	}
	...
	public static boolean everyMinutes(float numberOfMinutes, int tickCount,
			long periodInMillis) {
		return everySeconds(numberOfMinutes * 60, tickCount, periodInMillis);
	}

	public static boolean everySeconds(float numberOfSeconds, int tickCount,
			long periodInMillis) {
